...
class FinishFragment : Fragment() {
    ...
    private fun setupView(foodArgs: Food) {
        binding?.apply {
            contentFinish.apply {
            ...
            btnHome.setOnClickListener {
                val option = NavOptions.Builder()
                    .setPopUpTo(R.id.food_graph, inclusive = true)
                    .build()
                findNavController().navigate(FinishFragmentDirections.actionFinishFragmentToHomeGraph(), option)
            }
        }
    }
