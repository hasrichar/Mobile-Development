...
public class TechniqueFragmentDirections {
  private TechniqueFragmentDirections() {
  }

  @NonNull
  public static ActionTechniqueFragmentToTechniqueGraph actionTechniqueFragmentToTechniqueGraph(
      @NonNull Information information) {
    return new ActionTechniqueFragmentToTechniqueGraph(information);
  }

  public static class ActionTechniqueFragmentToTechniqueGraph implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionTechniqueFragmentToTechniqueGraph(@NonNull Information information) {
      if (information == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionTechniqueFragmentToTechniqueGraph setInformation(
        @NonNull Information information) {
      if (information == null) {
        throw new IllegalArgumentException("Argument \"information\" is marked as non-null but was passed a null value.");
      }
    ...
    public int getActionId() {
      return R.id.action_techniqueFragment_to_technique_graph;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionTechniqueFragmentToTechniqueGraph that = (ActionTechniqueFragmentToTechniqueGraph) object;
    ...
    public String toString() {
      return "ActionTechniqueFragmentToTechniqueGraph(actionId=" + getActionId() + "){"
