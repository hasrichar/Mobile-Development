...
public class CategoryFragmentDirections {
  ...
  @NonNull
  public static ActionCategoryFragmentToFoodGraph actionCategoryFragmentToFoodGraph(
      @NonNull Food food) {
    return new ActionCategoryFragmentToFoodGraph(food);
  }

  public static class ActionCategoryFragmentToFoodGraph implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionCategoryFragmentToFoodGraph(@NonNull Food food) {
      if (food == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionCategoryFragmentToFoodGraph setFood(@NonNull Food food) {
      if (food == null) {
        throw new IllegalArgumentException("Argument \"food\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("food", food);
    ...
    public int getActionId() {
      return R.id.action_categoryFragment_to_food_graph;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionCategoryFragmentToFoodGraph that = (ActionCategoryFragmentToFoodGraph) object;
    ...
    public String toString() {
      return "ActionCategoryFragmentToFoodGraph(actionId=" + getActionId() + "){"
          + "food=" + getFood()
          + "}";
    }
  }
