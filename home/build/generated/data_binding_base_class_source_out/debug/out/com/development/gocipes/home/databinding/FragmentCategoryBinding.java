...
public final class FragmentCategoryBinding implements ViewBinding {
  ...
  private FragmentCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvFood,
  ...
  public static FragmentCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCategoryBinding((ConstraintLayout) rootView, rvFood, toolbar);
    }
