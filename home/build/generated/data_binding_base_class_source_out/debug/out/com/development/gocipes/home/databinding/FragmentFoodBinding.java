...
public final class FragmentFoodBinding implements ViewBinding {
  ...
  private FragmentFoodBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvFood,
  ...
  public static FragmentFoodBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFoodBinding((ConstraintLayout) rootView, rvFood, toolbar);
    }
