package com.development.gocipes.view.main.analysis.adapter
...
import com.development.gocipes.databinding.ItemAnalysisBinding
...
//            itemView.setOnClickListener { data.invoke(analysis) }
    ...
    companion object {
        val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Analysis>() {
            override fun areItemsTheSame(oldItem: Analysis, newItem: Analysis) =
                oldItem == newItem

            override fun areContentsTheSame(oldItem: Analysis, newItem: Analysis) =
                oldItem == newItem
        }
    }
}