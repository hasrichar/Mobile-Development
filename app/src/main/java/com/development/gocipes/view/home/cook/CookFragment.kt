package com.development.gocipes.view.home.cook
...
import com.development.gocipes.view.home.adapter.CookAdapter
...
class CookFragment : Fragment() {
    ...
    private fun setupRecyclerView(cookArgs: List<Cook>) {
        ...
        cookAdapter.submitList(cookArgs)
    }
